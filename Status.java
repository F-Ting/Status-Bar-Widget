 ...
 * Some feature of this status include different status that can be applied to the target such as "Invincibility, Fire Power, Flight and Poisoned", each with a unique color assigned to it.
 * <p>
...
public class Status extends Actor
{
     ...
     * 
     * @param
     *   stts status(available string words are : "Flight", "Fire Power", "Poisoned", "Invincibility".
     */
...

    {
        ...
        myImage.drawString("Poisoned", 10,30);
...

    {
        ...
        if (this.status == "Poisoned")  
            drawPoison();                           //draw the image for poisoned
